...
export function buildLlmsTxt(routes, baseUrl = BASE_URL) {
  ...
  const lines = [
    ...
    `- [Policies & Terms](${mdUrl('legal')}): Legal and accessibility information for this website`,
    `- [Privacy Policy](${mdUrl('privacy')}): How personal information is collected, used, and shared`,
    `- [Cookie Policy](${mdUrl('cookies')}): Browser storage, site analytics, and browser controls`,
    `- [Terms of Use](${mdUrl('terms')}): Rules and limitations that apply when using this website`,
    `- [Accessibility Statement](${mdUrl('accessibility')}): Accessibility approach and feedback process`,
    '',
    '## Case Studies',
    '',
