      ...
      <div className="content main-section">
        <div className="main-section-top">
          ...
          <div className="main-section-top-right">
            <h1>MYCO</h1>
            <p>Myco is a social community based on cultural creation, ecological and spiritual views. The community is mostly funded from member fees and selling tickets to events organized for community members / the organization itself.</p>
