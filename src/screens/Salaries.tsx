      ...
      <div className="salaries">
        <section className="salaries-top" style={{ backgroundImage: `url('${assets.salariesTopBg}')` }}>
          <div className="container">
            ...
            <p>
              The Sanitation HR department was responsible for manually calculating and approving salary additions for
              employees, including attendance for absences and extra hours compensations. This web system offers an
              automated solution to streamline and automate this process for them.
            </p>
          </div>
        </section>
        ...
        <section className="salaries-pas">
          <div className="content">
            <h2>Problem</h2>
            <p>
              The HR coordinators were tasked with a labor-intensive process of reviewing manually the monthly
              ...
              agreements. This was a tiring, time consuming & ineffective process, prone to mistakes.
            </p>
            <h2>Solution</h2>
            ...
            <div className="content-solutions">
              <div className="content-solutions-item">
                <div className="content-solutions-item-left">
                  <CircleIcon
                    backgroundColor={'rgba(20, 136, 204, 0.1)'}
                    icon={ICONS_MAP.CALCULATOR}
                    iconColor={'#1488CC'}
                  />
                </div>
            ...
            <div className="content-role">
              ...
              <p>
                *Due to budget & time limitations, extensive compromises had to be done. The visual design is focused on
                a usable level with focus on functionality.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="salaries-tldr">
          <div className="content">
            <div className="content-left">
              ...
              <ul>
                <li>
                  Users like <span>flexibility</span> in the system
                </li>
                <li>
                  <span>Ongoing communication</span> with stakeholders & users led to high engagement
                </li>
                <li>
                  Displaying only <span>relevant information</span>
                </li>
              </ul>
            </div>
            <div className="content-right">
              <PercentageCircle
                percent={98.5}
                text={'Success rates in calculations'}
                circleColor={'#D9F8FF'}
          ...
          <div className="content">
            ...
            <div className="content-content">
              <div className="content-content-left">
                <h4>Interviews</h4>
                <p>
                  I conducted interview to gather qualitative feedback on the existing process, and get insights from
                  users.
                  <br />I conducted 5-7 interviews with the main stakeholder, HR manager, in order to understand their
                  work process and learn their calculation tables.
                  <br />I also conducted interviews with 2-3 users from each type of user group: Station Managers and HR
                  Coordinators.
                </p>
              </div>
              <div className="content-content-right">
                ...
                <div className="content-content-right-row multiple">
                  ...
                  />
                  <CircleIcon
                    backgroundColor={'#0E8F99'}
                    text={'HR Coordinators'}
                    icon={ICONS_MAP.USERS}
                    iconColor={'#ffffff'}
                  />
                </div>
        ...
        <section className="salaries-observations">
          <div className="content">
            ...
            <p>
              ...
              <br />
              For that, I conducted several interviews with HR manager, as well as interviewed some of the HR
              coordinators.
        ...
        <section className="salaries-flows">
          <div className="content">
            ...
            <p>
              The solution was composed of two main processes, designed to address the specific challenges of the
              project:
            </p>
            <div className="content-part side-by-side">
              <div className="side-by-side-left">
                ...
                <p>
                  The best solution was to report hours through the existing Sanitation tasks management system.
                  Employees preforms 1-3 tasks each day, which are already managed in this system by work manager. We
                  added fields to the screen, allowing to report, enabling to report start & end time for each task.
                </p>
              </div>
            ...
            <div className="content-part side-by-side">
              <div className="side-by-side-left">
                ...
                <p>
                  The business logic & salary additions calculations were documented in over 30 flowcharts I created and
                  delivered to the developer, and later on tested before moving to production.
                </p>
                <p>
                  In the screenshots here, you can see the list of flow charts assembling together the calculation
                  algorithm
                </p>
        ...
        <section className="salaries-test">
          <div className="content">
            ...
            <p>
              We aimed for the manual approval process to be as fluent as possible, in order to improve the existing
              process and shorten the overall time of approval.
            </p>
            <div className="content-part">
              <h4>Wireframes</h4>
              ...
              <div className="side-by-side">
                <div className="side-by-side-left">
                  ...
                  <div className="side-by-side-left-middle">
                    <p>
                      After assembling the solution, we had to test with some users that the process could run smoothly,
                      and check for any unexpected problems.
                    </p>
                    <p>
                      First, we thought our first group of users how to report attendance to the systems, keeping it
                      simple and making sure to let them feel like it won’t add to their workload.{' '}
                    </p>
                    <p>We provided incentives to encourage them:</p>
                    <ul>
                      <li>
                        <span>Extra hours report</span> allowing them to see aggregated data on attendance and absences,
                        an overall look on their entire station state.
                      </li>
                      <li>
                        <span>Validation</span> we defined a set of rules to the system, so that the system could
                ...
                <div className="side-by-side-right">
                  ...
                  <div className="side-by-side-right-middle">
                    ...
                    <p>
                      The 1st stage algorithms we implemented, for the basic calculations, work well in proving the
                      extra compensation required for each employee.
                      <br />
                      This was an important stage in the process, with the users & I meticulously manually reviewing the
                      output for 3 months, working alongside the developers to fix incorrections.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="salaries-main-screen-and-ui">
          <div className="content">
            ...
            <p>
              We improved the design and development of the project by customizing the screens and enhancing the
              algorithms while constantly testing and making adjustments, despite any limitations we faced
            </p>
          ...
          <div className="content">
            <div className="content-part side-by-side">
              <div className="side-by-side-left">
                ...
                <h2>Final results</h2>
                <p>
                  The project took around one year to complete, during which we expanded the algorithm to cater to all
                  types of employees and special events that required unique calculations. I collaborated closely with
                  the HR department to handle any arising issues, fix bugs, and add new features.
                </p>
                <p>
                  We also tracked the usage of the system via the system dashboard, and asked the developer to create a
                  report on the automation usage in the system.
                </p>
              </div>
              <div className="side-by-side-right">
                ...
                <div className="side-by-side-right-row multiple">
                  <div className="side-by-side-right-row-item">
                    <PercentageCircle
                      percent={95}
                      text={'Cards approved (on average) by the 10th day of each month'}
                      circleColor={'#1488CC'}
                      textColor={'#151B21'}
                    />
                  </div>
